...
class UserEditForm(UserChangeForm):
    class Meta:
        ...
        model = User
        fields = ('image', 'username', 'first_name',
                  'email', 'age', 'password')
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items():
            ...
            # elif field_name == 'cordinats':
            #     field.widget.attrs['class'] = 'age-edit form-control'
            #     field.widget.attrs['placeholder'] = 'cordinats'
            # elif field_name == 'telegram':
            #     field.widget.attrs['class'] = 'age-edit form-control'
            #     field.widget.attrs['placeholder'] = 'telegram'
